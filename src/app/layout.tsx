...
export const metadata: Metadata = {
  title: {
    default: 'NTrack',
    template: '%s | NTrack' // Keeps your "Dashboard" template functionality if needed later
  },
  description: 'Your PWA Description',
  icons: {
    apple: '/icons/icon-192x192.png', // Moves your icon declaration to the official metadata API
  },
  appleWebApp: {
    capable: true,
    statusBarStyle: 'black-translucent', // Updated to match your custom head choice
    title: 'NTrack',
    startupImage: [
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      {/* Next.js injects the viewport settings, icons, meta tags, and 
        startup images directly into the HTML head out-of-the-box.
      */}
